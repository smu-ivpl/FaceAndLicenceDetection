...
if __name__ == '__main__':
    ...
    dataset = PennFudanDataset('E:\Datasets\PennFudanPed', get_transform(train=True))
    dataset_test = PennFudanDataset('E:\Datasets\PennFudanPed', get_transform(train=False))
